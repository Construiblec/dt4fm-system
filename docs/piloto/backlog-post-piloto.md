...
| BP-024 | P3 | B | Arranque en frío de **41,6 s** en el plan Free de Render tras 15 min sin tráfico. Si las sesiones de usabilidad de la certificación se hacen contra staging, los participantes reportarán lentitud que no dice nada del producto. Solo afecta a staging: producción, en plan de pago, no se suspende y se recuperó en **8 s** de una caída forzada |
