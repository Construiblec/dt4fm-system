...
export const AsistenteSLTaskDetailPage = () => {
              ...
              <div className="space-y-3 pb-4">
                ...
                {detail.canReview && (
                  <button
                    ...
                    className="flex w-full items-center justify-center gap-2 rounded-2xl bg-fuchsia-600 px-4 py-4 text-sm font-bold text-white shadow-md transition hover:bg-fuchsia-700"
                  >
      ...
      {showReviewModal && detail && (
        <ReviewModal
          task={{
            ...
            sessionStartedAt: detail.sessionStartedAt,
            sessionBaseMinutes: detail.sessionBaseMinutes,
