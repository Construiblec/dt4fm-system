...
/**
 * Tarjeta de tarea para el dashboard de AsistenteSL.
 * Idéntica a SupervisorTaskCard salvo que navega a `/asistente-sl/tasks/:id`
 * y usa fucsia en lugar de violeta.
 */
export const AsistenteSLTaskCard = ({ task }: Props) => {
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 flex justify-end gap-2">
        <button
          type="button"
          onClick={() => navigate(`/asistente-sl/tasks/${task.id}`)}
          className="rounded-lg bg-fuchsia-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-fuchsia-700"
        >
